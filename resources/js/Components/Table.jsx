...
function Thead({ children }) {
    return (
        <thead className="text-xs text-gray-700 uppercase bg-white divide-y divide-gray-200">
            {children}
        </thead>
    );
}
function Th({ className, children }) {
    return (
        <th scope="row" className={clsx("px-4 py-3", className)}>
            {children}
        </th>
    );
}
...
function Tr({ className, children }) {
    return (
        <tr className={clsx("bg-white dark:bg-gray-800", className)}>
            {children}
        </tr>
    );
}
